		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sample Northwind",
									"targetURL": "#comsamplesampleproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsamplesampleproject-display": {
								"semanticObject": "comsamplesampleproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sample.sampleproject",
									"url": sap.ui.require.toUrl("com/sample/sampleproject")
								}
							}
						}
					}
